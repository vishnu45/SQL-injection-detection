...
/**
 * @ast node
 * @declaredat C:\\Users\\vishnu\\Documents\\GitHub\\SQL-injection-detection\\spec\\php.ast:14
 * @production FileLitExpr : {@link Expr} ::= <span class="component">&lt;Contents:String&gt;</span>;

 */
public class FileLitExpr extends Expr implements Cloneable {
  /**
   * @apilevel internal
   */
  public FileLitExpr clone() throws CloneNotSupportedException {
    FileLitExpr node = (FileLitExpr) super.clone();
    node.FV_visited = -1;
    node.RV_visited = -1;
   ...
   * @apilevel internal
   */
  public FileLitExpr copy() {
    try {
      FileLitExpr node = (FileLitExpr) clone();
      node.parent = null;
      if(children != null) {
   ...
   * @apilevel low-level
   */
  public FileLitExpr fullCopy() {
    FileLitExpr tree = (FileLitExpr) copy();
    if (children != null) {
