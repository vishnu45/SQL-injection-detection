...
/**
 * @ast node
 * @declaredat C:\\Users\\vishnu\\Documents\\GitHub\\SQL-injection-detection\\spec\\php.ast:16
 * @production PostExpr : {@link Expr} ::= <span class="component">&lt;Contents:String&gt;</span>;

 */
public class PostExpr extends Expr implements Cloneable {
  /**
   * @apilevel internal
   */
  public PostExpr clone() throws CloneNotSupportedException {
    PostExpr node = (PostExpr) super.clone();
    node.FV_visited = -1;
    node.RV_visited = -1;
   ...
   * @apilevel internal
   */
  public PostExpr copy() {
    try {
      PostExpr node = (PostExpr) clone();
      node.parent = null;
      if(children != null) {
   ...
   * @apilevel low-level
   */
  public PostExpr fullCopy() {
    PostExpr tree = (PostExpr) copy();
    if (children != null) {
  ...
  public Set<String> RV() {
    ...
    try {  return SetRepUtility.singleton(getContents());  }
    finally {
      RV_visited = -1;
    }
  }
