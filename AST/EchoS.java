...
/**
 * @ast node
 * @declaredat C:\\Users\\vishnu\\Documents\\GitHub\\SQL-injection-detection\\spec\\php.ast:33
 * @production EchoS : {@link S} ::= <span class="component">LabelAST:{@link Label}</span> <span class="component">{@link Expr}</span>;

 */
public class EchoS extends S implements Cloneable, Block {
  /**
   * @apilevel internal
   */
  public EchoS clone() throws CloneNotSupportedException {
    EchoS node = (EchoS) super.clone();
    node.init_visited = -1;
   ...
   * @apilevel low-level
   */
  public EchoS fullCopy() {
    EchoS tree = (EchoS) copy();
    if (children != null) {
  ...
  /**
   * @declaredat C:\\Users\\vishnu\\Documents\\GitHub\\SQL-injection-detection\\spec\\CFG.jrag:119
   * @apilevel internal
   */
