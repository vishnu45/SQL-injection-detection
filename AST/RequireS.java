...
/**
 * @ast node
 * @declaredat C:\\Users\\vishnu\\Documents\\GitHub\\SQL-injection-detection\\spec\\php.ast:34
 * @production RequireS : {@link S} ::= <span class="component">LabelAST:{@link Label}</span> <span class="component">{@link Expr}</span>;

 */
public class RequireS extends S implements Cloneable, Block {
  /**
   * @apilevel internal
   */
  public RequireS clone() throws CloneNotSupportedException {
    RequireS node = (RequireS) super.clone();
    node.init_visited = -1;
   ...
   * @apilevel low-level
   */
  public RequireS fullCopy() {
    RequireS tree = (RequireS) copy();
    if (children != null) {
  ...
  /**
   */
  public RequireS(Label p0, Expr p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
  ...
  public Set<Label> finals() {
    ...
    try {  return SetRepUtility.singleton(getLabelAST());  }
    finally {
      finals_visited = -1;
    }
  }
  ...
  public Set<Block> blocks() {
    ...
    try {  return SetRepUtility.singleton(this);  }
    finally {
      blocks_visited = -1;
    }
  }
  ...
  public FlowGraph<Label, Label> flows() {
    ...
    try {  return new FlowGraph<Label, Label>();  }
    finally {
      flows_visited = -1;
    }
  }
  ...
  /**
   * @declaredat C:\\Users\\vishnu\\Documents\\GitHub\\SQL-injection-detection\\spec\\CFG.jrag:120
   * @apilevel internal
   */
