...
/**
 * @ast node
 * @declaredat C:\\Users\\vishnu\\Documents\\GitHub\\SQL-injection-detection\\spec\\php.ast:13
 * @production StrLitExpr : {@link Expr} ::= <span class="component">&lt;Contents:String&gt;</span>;

 */
public class StrLitExpr extends Expr implements Cloneable {
  /**
   * @apilevel internal
   */
  public StrLitExpr clone() throws CloneNotSupportedException {
    StrLitExpr node = (StrLitExpr) super.clone();
    node.FV_visited = -1;
    node.RV_visited = -1;
   ...
   * @apilevel internal
   */
  public StrLitExpr copy() {
    try {
      StrLitExpr node = (StrLitExpr) clone();
      node.parent = null;
      if(children != null) {
   ...
   * @apilevel low-level
   */
  public StrLitExpr fullCopy() {
    StrLitExpr tree = (StrLitExpr) copy();
    if (children != null) {
